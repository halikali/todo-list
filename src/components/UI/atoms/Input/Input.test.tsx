...
describe('Input', () => {
  it('renders an input', () => {
    render(<Input size="large" type="text" placeholder="Placeholder" />)
  ...
  it('renders the correct type', () => {
    render(<Input size="large" placeholder="Placeholder" type="text" />)
    const renderedInput = screen.getByPlaceholderText('Placeholder')
    expect(renderedInput).toHaveAttribute('type', 'text')
  })

  it('renders the correct placeholder', () => {
    render(<Input size="large" placeholder="Example Placeholder" type="text" />)
  ...
  it('renders the correct disabled state', () => {
    render(<Input size="large" placeholder="Placeholder" type="text" disabled />)
    const renderedInput = screen.getByPlaceholderText('Placeholder')
